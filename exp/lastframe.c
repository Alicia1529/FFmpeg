...
int main(int argc, char *argv[]) {
    ...
    printf("""after avformat_open_input: nb_streams %d, url %s, start_time %d, duration %d, bit_rate %d, \
stream.time_base.den %d, stream.time_base.num %d, \
stream.index %d, stream.start_time %d, stream.duration %d, stream.nb_frames %d\n\n""", pFormatCtx->nb_streams, pFormatCtx->url,
pFormatCtx->start_time, pFormatCtx->duration, pFormatCtx->bit_rate,
pFormatCtx->streams[0]->time_base.den, pFormatCtx->streams[0]->time_base.num,
pFormatCtx->streams[0]->index, pFormatCtx->streams[0]->start_time, pFormatCtx->streams[0]->duration, pFormatCtx->streams[0]->nb_frames);
    ...
    printf("""after avformat_find_stream_info: nb_streams %d, url %s, start_time %d, duration %d, bit_rate %d, \
stream.time_base.den %d, stream.time_base.num %d, \
stream.index %d, stream.start_time %d, stream.duration %d, stream.nb_frames %d\n\n""", pFormatCtx->nb_streams, pFormatCtx->url,
pFormatCtx->start_time, pFormatCtx->duration, pFormatCtx->bit_rate,
pFormatCtx->streams[0]->time_base.den, pFormatCtx->streams[0]->time_base.num,
pFormatCtx->streams[0]->index, pFormatCtx->streams[0]->start_time, pFormatCtx->streams[0]->duration, pFormatCtx->streams[0]->nb_frames);
    ...
    last_frame = pFormatCtx->streams[videoStream]->nb_frames;
